...
public:
	...
	bool doesAlbumExists(const std::string& albumName) override;
	Album openAlbum(const std::string& albumName) override;
	void closeAlbum(Album &pAlbum) override;
	void printAlbums() override;
	std::string getAlbumID(const std::string& albumName);
	...
	std::string getPictureID(const std::string& pictureName, std::string album_ID );
